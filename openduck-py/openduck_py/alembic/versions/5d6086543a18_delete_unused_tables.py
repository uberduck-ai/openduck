...
def downgrade() -> None:
    ...
    op.create_foreign_key(None, 'chat_history', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_index('prompt_user_id_url_name_unique_not_deleted', 'template_prompt', ['user_id', 'url_name'], unique=1, sqlite_where=sa.text('deleted_at IS NULL'))
    op.create_index('ix_template_prompt_uuid', 'template_prompt', ['uuid'], unique=1)
    op.create_index('ix_template_prompt_user_id', 'template_prompt', ['user_id'], unique=False)
    op.create_index('ix_template_prompt_url_name', 'template_prompt', ['url_name'], unique=False)
    ...
    op.create_index('ix_template_deployment_user_id', 'template_deployment', ['user_id'], unique=False)
    op.create_index('ix_template_deployment_url_name', 'template_deployment', ['url_name'], unique=False)
    op.create_index('ix_template_deployment_id', 'template_deployment', ['id'], unique=False)
    op.create_index('deployment_user_id_url_name_unique_not_deleted', 'template_deployment', ['user_id', 'url_name'], unique=1, sqlite_where=sa.text('deleted_at IS NULL'))
